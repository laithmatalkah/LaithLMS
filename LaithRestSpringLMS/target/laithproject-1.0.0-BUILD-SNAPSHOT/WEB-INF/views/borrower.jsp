...
<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
	...
	if(request.getAttribute("authors")!=null){
		borrowers = (List<Borrower>)request.getAttribute("authors");	
	}else{
...
<script>
function deleteBorro(aid) {
    var answer = confirm("Are you sure you want to delete Author?");
    if (answer == true) {
        location.href = "delBorro?cardNo=".concat(aid);
    }
}
</script>
<script>
...
<form action="addBorro" method="post">
...
<button type="submit" name="btn" value="addBorro" class="btn btn-primary">Add Borrower</button><br/>
...
<thead>
	...
	<%for(Borrower br: borrowers){ %>
		<tr>
			...
			href='editborrower.jsp?cardNo=<%=br.getCardNo()%>'">EDIT</button></td>
			 <td align="center"><a type="button" name="btn" value="delBorro"class="btn btn-sm btn-danger" onclick="deleteBorrower(<%=br.getCardNo() %>)">DELETE</a></td>
			</tr>
	<%} %>	
	</tbody>
</table>
